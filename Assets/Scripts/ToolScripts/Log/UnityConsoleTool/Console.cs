...
public static class Console
{
    ...
    public static void Init()
    {
        ...
        Log.Info(LogColor.Dye(LogColor.EColor.deep_blue, "Console init"));
    }
    ...
    public static void OnDestroy()
    {
        ...
        Log.Info(LogColor.Dye(LogColor.EColor.deep_blue, "Console Destroy"));
    }
    #endregion
    ...
    static void RunPythonConsole()
    {
        if (m_ChildProcess != null)
            return;
        string cmd = string.Format(Environment.CurrentDirectory + "/Assets/Scripts/ToolScripts/Log/UnityConsoleTool/Tools/DebugTool.py");

...
public static partial class Log
{
    ...
    public static void ConsoleLog(string value)
    {
        if (s_LogHelper == null)
            return;
        s_LogHelper.ConsoleWriteLine(value);
    }
    public static void ConsoleLog<T1>(T1 arg1)
    {
        if (s_LogHelper == null)
            return;
        s_LogHelper.ConsoleWriteLine(Utility.Text.Format("{0}", arg1));
    }

    public static void ConsoleLog<T1>(string format, T1 arg1)
    {
        if (s_LogHelper == null)
            return;
        s_LogHelper.ConsoleWriteLine(Utility.Text.Format(format, arg1));
    }

    public static void ConsoleLog<T1, T2>(string format, T1 arg1, T2 arg2)
    {
        if (s_LogHelper == null)
            return;
        s_LogHelper.ConsoleWriteLine(Utility.Text.Format(format, arg1, arg2));
    }


    public static void ConsoleLog<T1, T2, T3>(string format, T1 arg1, T2 arg2, T3 arg3)
    {
        if (s_LogHelper == null)
            return;
        s_LogHelper.ConsoleWriteLine(Utility.Text.Format(format, arg1, arg2, arg3));
    }

    public static void ConsoleLog<T1, T2, T3, T4>(string format, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
    {
        if (s_LogHelper == null)
            return;
        s_LogHelper.ConsoleWriteLine(Utility.Text.Format(format, arg1, arg2, arg3, arg4));
    }
    ...
    public static void UILog(string value)
    {
        if (s_LogHelper == null)
            return;
        s_LogHelper.UILog(value);
    }


    public static void UILog<T1>(string key, T1 arg1)
    {
        if (s_LogHelper == null)
            return;
        s_LogHelper.UILogDataUpdate(key, Utility.Text.Format("{0}", arg1));
    }

    public static void UILog<T1>(string key, string format, T1 arg1)
    {
        if (s_LogHelper == null)
            return;
        s_LogHelper.UILogDataUpdate(key, Utility.Text.Format(format, arg1));
    }
    public static void UILog<T1, T2>(string key, string format, T1 arg1, T2 arg2)
    {
        if (s_LogHelper == null)
            return;
        s_LogHelper.UILogDataUpdate(key, Utility.Text.Format(format, arg1, arg2));
    }
    public static void UILog<T1, T2, T3>(string key, string format, T1 arg1, T2 arg2, T3 arg3)
    {
        if (s_LogHelper == null)
            return;
        s_LogHelper.UILogDataUpdate(key, Utility.Text.Format(format, arg1, arg2, arg3));
    }
    public static void UILog<T1, T2, T3, T4>(string key, string format, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
    {
        if (s_LogHelper == null)
            return;
        s_LogHelper.UILogDataUpdate(key, Utility.Text.Format(format, arg1, arg2, arg3, arg4));
    }
